...
public abstract class VersionedGraphBase<T extends KeyIndexableGraph & IndexableGraph, V extends Comparable<V>>
     ...
     * 
     * @see com.vertixtech.antiquity.graph.identifierBehavior.GraphIdentifierBehavior#getMinPossibleGraphVersion()
     ...
     * 
     * @see com.vertixtech.antiquity.graph.identifierBehavior.GraphIdentifierBehavior#getMaxPossibleGraphVersion()
